#ifndef NO_INFER_DATA_TENSOR_HPP
#define NO_INFER_DATA_TENSOR_HPP
 ...
 *       1，4，7
 *       2，5，8
 * pytorch中张量默认行主序，而armadillo里默认列主序。
 */
template <>
class Tensor<float> {
 public:
   ...
   * @param rows 张量的行数即height
   * @param cols 张量的列数即width
   */
...
#endif  // NO_INFER_DATA_TENSOR_HPP